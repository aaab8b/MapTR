...
## normal config
CONFIG=${PWD}/projects/configs/maptrv2/maptrv2_nusc_r50_24ep_bf16.py 
...
./tools/bf16/dist_train.sh $CONFIG 1 --work-dir ${WORK_DIR} # 2>&1 | tee perf_ana/miopen_raw_info_1iter.log
