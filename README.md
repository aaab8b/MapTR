...
4. export CUDA_HOME=/opt/rocm
5. cd projects/mmdet3d_plugin/maptr/modules/ops/ and install bev_pool, bev_pool_v2, and geometric_kernel_attention by python3 setup.py install.
6. To use original fp16 training, sh run_train_fp16.sh.
